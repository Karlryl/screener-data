...
|---|-------------|-------------|--------|---------|
| 1 | **Benchmark-Alpha reparieren** | SPY/QQQ/IWM in `pull-historical-prices.js`-Universum aufnehmen (oder separaten Mini-Pull). Walk-forward warnt heute bei jedem Lauf `alphaVsBenchmark will be null` und fällt auf Universums-Median zurück — α-Zahlen sind dadurch nicht marktbenchmarked. | HOCH | KLEIN |
