...
function ladeRegelwerk(pfad = REGELWERK_PFAD) {
  ...
  try {
    ...
    // S43: Herkunft nennen, Originalfehler als cause. Bewusst normaler Error,
    // kein VerfassungsBruch - sonst aendert sich die Fehlerklasse fuer Aufrufer.
    throw new Error('Regelwerk ' + pfad + ': ungueltiges JSON: ' + e.message, { cause: e });
  }
}
