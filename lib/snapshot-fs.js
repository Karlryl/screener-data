 ...
 * @param {string} ticker - Ticker to encode as a portable snapshot filename.
 * @returns {string} Sanitized JSON filename with reserved Windows names escaped.
 */
 ...
 * @param {string} filename - Snapshot basename to classify.
 * @returns {boolean} Whether the name is one of the recognized metadata files.
 */
