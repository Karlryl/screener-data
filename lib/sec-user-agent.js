...
/**
 * Prueft den SEC-Kontakt aus der Umgebung vor dem Abruf.
 * @returns {string} Getrimmter Kontakt mit einem @-Zeichen.
 * @throws {Error} SEC_CONTACT fehlt oder enthaelt kein @-Zeichen.
 */
