...
/**
 * Liest und entpackt die gzip-Rohzeilen eines Sitzungstags mit sichtbarem Fehlerhinweis.
 * @param {string} rawDir - Verzeichnis der gzip-Tagesdateien.
 * @param {string} datum - Sitzungstag YYYY-MM-DD.
 * @param {function(string): void} [log] - Optionale Meldungsfunktion fuer Lesefehler.
 * @returns {Array<Object>|null} Rohzeilen oder null bei fehlender beziehungsweise unbrauchbarer Datei.
 */
 ...
 * @param {Array<{ticker: string, atSession: boolean, bars: number}>} rohZeilen - Rohzeilen mit Frische- und Balkenzahl.
 * @returns {Set<string>} Ticker mit Sitzungstagsbalken und Mindesthistorie.
 */
