 ...
 * @param {string} xml - XML-Inhalt einer SEC-Informationstabelle.
 * @returns {Array<Object>} Positionen mit Emittent, CUSIP, Wert, Anteilen und Optionstag.
 * @throws {Error} Keine Informationstabelle oder keine Position wurde gefunden.
 */
 ...
 * @param {{putCall?: string, cusip?: string}|null} row - Zu pruefende Filing-Position.
 * @returns { {option: boolean, reason: string|null} } Optionsbefund mit ausloesendem Merkmal.
 */
...
/**
 * Berechnet den Median auf einer sortierten Kopie der uebergebenen Werte.
 ...
 * @param {Array<Object>} rows - Positionen mit valueRaw, shares und optional ticker.
 * @param {Map<string, number>} [closes] - Schlusskurse am Periodenende nach Ticker.
 * @returns {Object} Einheit, Quarantaene, Pruefmodus und Plausibilitaetskennzahlen.
 */
...
/**
 * Normalisiert Emittentennamen durch Kleinschreibung und Entfernen von Rechtsformen und Interpunktion.
 * @param {string} s - Name aus Filing oder lokaler Namenskarte.
 * @returns {string} Normalform; leer fuer Nicht-Strings.
 */
function normName(s) {
 ...
 * @param {Map<string, string>} nameMap - Lokale Zuordnung Ticker zu Emittentenname.
 * @returns {Map<string, Array<{ticker: string, name: string}>>} Kandidaten nach normalisiertem Namen.
 */
 ...
 * @param {string} filingName - Emittentenname aus dem Filing.
 * @param {string} kartenName - Name aus der lokalen Tickerkarte.
 * @returns {boolean} Ob Gleichheit oder erlaubte Praefixabweichung besteht.
 */
 ...
 * @param {string} issuerName - Name aus dem Filing.
 * @param {Map<string, Array<{ticker: string, name: string}>>} nameIndex - Normalisierter lokaler Namensindex.
 * @returns { {ticker: string|null, reason: string, matchedName?: string} } Eindeutiger Treffer oder erklaerter Fehlschlag.
 */
 ...
 * @param {string} issuerName - Filing-Name.
 * @param {string} mappedName - Name des moeglichen Kartentreffers.
 * @returns {boolean} Ob die normalisierten Namen identisch oder erlaubt praefixverwandt sind.
 */
 ...
 * @param {Object} opts - Quartalsdaten mit XML, lokaler Namenskarte und optionalen Schlusskursen.
 * @returns {Object} Quartalsausgabe mit gemappten Positionen, Abdeckung und Quarantaene-Befund.
 */
 ...
 * @param {string} ticker - Zu pruefender Ticker.
 * @param {Set<string>} heldTickers - Eindeutig gehaltene Ticker.
 * @param {number} coverage - Endlicher positiver Mapping-Abdeckungsanteil.
 * @returns {string} HELD, NOT_IN_MAPPED oder UNMAPPED.
 */
 ...
 * @param {Array<{issuer: string}>} issuers - Zu pruefende Emittenten.
 * @param {Map<string, Array<{ticker: string, name: string}>>} nameIndex - Lokaler normalisierter Namensindex.
 * @returns {Object} Trefferzahlen, Mehrdeutigkeiten, Identitaetsablehnungen und Abdeckungsanteil.
 */
