 ...
 * @param {string} ticker - Tickerkennung.
 * @returns {boolean} Ob die Kennung einen Punkt enthaelt.
 */
 ...
 * @param {{country?: string, ticker?: string, _newestQtrSuspect?: boolean, _annualCurrencyLeakSuspect?: boolean}} meta - Snapshot-Metadaten.
 * @param {number} bars - Anzahl nutzbarer Kursbalken.
 * @returns {string|null} Erster Ausschlussgrund oder null.
 */
 ...
 * @param {string} name - Snapshot-Dateiname.
 * @returns {boolean} Ob der Name den vorlaeufigen US-Dateifilter passiert.
 */
...
/**
 * Ordnet einen Sektor dem eingefrorenen zyklischen oder defensiven Korb zu.
 * @param {string|null} sector - Sektorbezeichnung aus dem Snapshot.
 * @returns {string} cyclical, defensive oder unassigned.
 */
...
/**
 * Prueft die Branchenbezeichnung gegen die benannten Korb-Fragmente ohne Grossschreibung.
 * @param {string|null} industry - Branchenbezeichnung aus dem Snapshot.
 * @returns {boolean} Ob mindestens ein benanntes Fragment vorkommt.
 */
 ...
 * @param {Object<string, {upLast30Days?: number, downLast30Days?: number}>} estimateRevisions - Revisionen nach Schaetzungshorizont.
 * @returns {number|null} Aufwaerts minus abwaerts fuer +1y oder null bei fehlenden Angaben.
 */
 ...
 * @param {number|{value?: number}|null} feld - Direkte Marktkapitalisierung oder Value-Wrapper.
 * @returns {number|null} Endliche Marktkapitalisierung oder null.
 */
 ...
 * @param {string[]} tickers - Mitglieder des Universums.
 * @returns {string} SHA-256 der sortierten Tickerfolge.
 */
 ...
 * @param {string} snapshotsDir - Lokales Snapshot-Verzeichnis.
 * @returns {Map<string, Object>} Kandidaten mit Sektor-, Branchen-, Marktkapitalisierungs- und Revisionsdaten; unreadable zaehlt Lesefehler.
 */
