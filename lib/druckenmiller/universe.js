...
function loadCandidates(snapshotsDir) {
  ...
  for (const name of fs.readdirSync(snapshotsDir)) {
    ...
    catch { continue; } // ein kaputter Einzel-Snapshot ist ein Ticker weniger, kein Ausfall des Tages
    ...
    out.set(ticker, {
      ...
      marketCap: Number.isFinite(snap.marketCap) ? snap.marketCap : null,
...
module.exports = {
  ...
  netRevision30, universeHash, loadCandidates,
};
