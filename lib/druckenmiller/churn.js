 ...
 * @param {Set<string>} vorher - Mitglieder der vorherigen Sitzung.
 * @param {Set<string>} jetzt - Mitglieder der aktuellen Sitzung.
 * @returns { {nEntered: number, nLeft: number} } Eintritte und Austritte.
 */
 ...
 * @param {number} nUniverse - Groesse des aktuellen Universums.
 * @param {number} nEntered - Neu eingetretene Mitglieder.
 * @param {number} nLeft - Ausgeschiedene Mitglieder.
 * @param {number} churnMax - Registrierte Schwelle zwischen null und eins.
 * @returns {boolean|null} Schwellenueberschreitung oder null ohne brauchbaren Nenner.
 * @throws {Error} Die registrierte Schwelle ist ungueltig.
 */
