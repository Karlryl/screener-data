 ...
 * @param {string} protocolDir - Verzeichnis der Registrierungsdateien.
 * @param {RegExp} glob - Ausdruck fuer die gesuchte Dateibezeichnung.
 * @param {string} label - Bezeichnung in Fehlermeldungen.
 * @returns { {datei: string, hash: string, json: Object} } Eindeutige Datei mit geprueftem Sidecar-Digest und Inhalt.
 * @throws {Error} Trefferzahl, SHA-256-Sidecar oder JSON-Inhalt sind ungueltig.
 */
