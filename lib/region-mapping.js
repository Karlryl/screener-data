...
const EXCHANGE_TO_REGION = {
  ...
  'IST': 'EM', 'BIST': 'EM',
  'MIC': 'EM', 'MCX': 'EM',
  // T576: Tadawul stand seit Tag 132 in EXCHANGE_CODES, aber nie hier — solange der
  // Exchange-Kanal tot war, ist das niemandem aufgefallen. Ab Tag 576 liefert er ~98
  // saudische Namen, die sonst alle im Eimer 'OTHER' landen wuerden.
  'SAU': 'EM', 'TADAWUL': 'EM',
};
...
const CURRENCY_TO_REGION_FALLBACK = {
  ...
  'SAR': 'EM',   // T576: Riyal, zweites Netz unter dem SAU-Eintrag oben
};
