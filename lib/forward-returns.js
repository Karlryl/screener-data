 ...
 * @param {Object<string, Map<string, number>>} priceIndex - Ticker price maps indexed by ISO date.
 * @param {string} ticker - Ticker whose forward window is classified.
 * @param {string} entryDate - Canonical entry date.
 * @param {string} exitDate - Canonical exit date.
 */
 ...
 * @param {Object<string, Map<string, number>>} priceIndex - Price maps including the benchmark.
 * @param {string} t0Iso - Requested start date.
 * @param {number} horizonDays - Requested calendar-day horizon.
 */
