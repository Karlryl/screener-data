 ...
 * @param {Map<string, Map<string, number>>} priceIndex - Ticker price maps indexed by ISO date.
 ...
 * @param {Map<string, Map<string, number>>} priceIndex - Price maps including the benchmark.
