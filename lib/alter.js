 ...
 * @param {number} zeitstempelMs - Quellzeitpunkt in Millisekunden seit Epoch.
 * @param {number} jetztMs - Vergleichszeitpunkt in Millisekunden seit Epoch.
 * @returns {number|null} Signiertes Alter in der jeweiligen Einheit; null bei unbrauchbarem Zeitstempel.
 */
 ...
 * entwarnen.
 * @param {number|null} alterInTagen - Bekanntes Datenalter oder null.
 * @param {number} maxTage - Noch erlaubtes Alter in Tagen.
 * @returns {boolean} Ob Alter oder Grenze unbrauchbar sind oder das Alter die Grenze ueberschreitet.
 */
 ...
 * @param {number|null} alterInTagen - Datenalter fuer die Anzeige.
 * @returns {string} Formatierte Tageszahl oder Hinweis auf unbekanntes Alter.
 */
