...
- The V4 research question, five clocks, exact growth event, market event, matrix states, matching, comparison arms and numerical failure rules are preregistered in version 1.1.0 after independent review.
...
| Independent audit | RED | The 1.1.0 corrections require a final outcome-blind re-review before execution. | Signed methodology, data and source audits with no unresolved P0/P1/P2 finding. |
