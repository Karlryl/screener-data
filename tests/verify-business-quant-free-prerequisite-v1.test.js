...
const script = path.join(root, 'scripts', 'verify-business-quant-free-prerequisite-v1.py');
const contract = path.join(root, 'research', 'early-detection-v4', 'business-quant-free-prerequisite-contract-v1.json');
const EXPECTED_RAW_SHA256 = '7ea5fa97868ecfe533b6bacb916fe8425c68b18eb8658aa3ccf4639cb24140e4';
...
console.log('verify-business-quant-free-prerequisite-v1.test.js: PASS');
