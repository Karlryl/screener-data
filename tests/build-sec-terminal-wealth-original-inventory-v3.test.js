...
const script = path.join(root, 'scripts', 'build-sec-terminal-wealth-original-inventory-v3.py');
const parserKills = [
  'arbitrary', 'noAccession', 'duplicateAccession', 'sequentialHeaders',
...
console.log('build-sec-terminal-wealth-original-inventory-v3.test.js: PASS');
