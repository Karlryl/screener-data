...
const ROOT=path.resolve(__dirname,'..'); const script=path.join(ROOT,'scripts','verify-quantconnect-free-cloud-pilot-v3.py');
...
const contract=JSON.parse(fs.readFileSync(path.join(ROOT,'research','early-detection-v4','quantconnect-free-cloud-pilot-contract-v3.json'),'utf8'));
...
console.log('quantconnect-free-cloud-pilot-v3.test.js: PASS');
