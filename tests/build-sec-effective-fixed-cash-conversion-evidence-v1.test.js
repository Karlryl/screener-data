...
const script = path.join(root, 'scripts', 'build-sec-effective-fixed-cash-conversion-evidence-v1.py');
const contract = path.join(root, 'research', 'early-detection-v4', 'sec-effective-fixed-cash-conversion-evidence-contract-v1.json');
const output = path.join(root, 'reports', 'early-detection', 'sec-effective-fixed-cash-conversion-evidence-v1.json');
const EXPECTED_CONTRACT_RAW = '091cecc6331b1b74b6bb5243313f73eaa331ad3a30fd37e9af0d589fbbe09bcd';
...
console.log('build-sec-effective-fixed-cash-conversion-evidence-v1.test.js: PASS');
