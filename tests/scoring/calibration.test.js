...
if (universe.length === 0) {
  ...
  console.log('::warning::calibration.test.js: leeres Universum — Contract/Replay/Inertness des Kalibrier-Artefakts wurden NICHT gemessen. Diese Suite meldet gruen, ohne etwas geprueft zu haben.');
