...
const SCRIPT = 'scripts/build-sec-form25-suspension-boundary-v1.py';
const CONTRACT = path.join(ROOT, 'research', 'early-detection-v4', 'sec-form25-suspension-boundary-contract-v1.json');
const BUILDER = path.join(ROOT, 'scripts', 'build-sec-form25-suspension-boundary-v1.py');
const OUTPUT = path.join(ROOT, 'reports', 'early-detection', 'sec-form25-suspension-boundary-v1.json');
...
const introduction = spawnSync('git', [
  ...
  'research/early-detection-v4/sec-form25-suspension-boundary-contract-v1.json',
...
assert.equal(contract.implementationContract.baseCommit, 'de137118554621bbfb2556c69e226ef14ec110a8');
assert.equal(contract.implementationContract.baseTag, 872);
