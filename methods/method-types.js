...
const REGISTRY = {
  ...
  'ohlson-o-score':             { type: 'DIAGNOSTIC', defaultActive: true,  reason: 'Tag 210a: Ohlson O-Score < 0 (P(bankruptcy) < 50%) — 9-variable logit bankruptcy probability (Ohlson 1980 JAR). Sibling to Altman-Z (discriminant) with different false-negative profile (services / low-leverage). DIAGNOSTIC until pull-yahoo extends CA/CL/totalLiab/OCF coverage — currently computable=false on all snapshots.' },
