...
function baueEintrag(runId, registeredAt, wirksamAb, m) {
  ...
  return {
    ...
    arbeitspfad: { pfad: ARBEITSPFAD,
      geprueft: 'VERBOTEN_RE-frei bis in die Elternverzeichnisse, ausserhalb des Repos; vor der '
        + 'Freigabe geprueft und hier genannt, nicht zur Laufzeit entdeckt (F6-C5 / KZ-3).' },
...
module.exports = { SKRIPTE, ARTEFAKTE, INHALT_SHA, INHALT_MODUS, DATEN_SCHLUESSEL,
