...
class FreeCloudMetadataPilotV3(QCAlgorithm):
    """Discovery-only metadata pilot; never exports prices, returns, holdings or alpha."""

    PILOT_CORE_SHA256 = "2e22f4cdad2032c6dbb5dc7e95c5c50b9854193a4a013a9c42dd5f00055d1f6c"
    ...
    def on_end_of_algorithm(self):
        ...
        report = {
            "schema":"early-detection-quantconnect-free-cloud-metadata-output/v3",
        ...
        self.log("QC_METADATA_V3=" + json.dumps(report, sort_keys=True, separators=(",", ":")))
