...
class FreeCloudMetadataPilotV5(QCAlgorithm):
    """Discovery-only metadata pilot; never exports prices, returns, holdings or alpha."""

    PILOT_CORE_SHA256 = "6b7c61e6898215d7997584f410bd8a383c328bdcb543c3d7edb11f173888c706"
    ...
    def on_end_of_algorithm(self):
        ...
        self.log("QC_METADATA_V5=" + json.dumps(report, sort_keys=True, separators=(",", ":")))
